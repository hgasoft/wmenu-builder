...
var wpNavOrganization;
! function(a) {
    var b;
    b = wpNavOrganization = {
        options: {
            organizationItemDepthPerLevel: 30,
            globalMaxDepth: 11
        },
        organizationList: void 0,
        targetList: void 0,
        organizationsChanged: !1,
        isRTL: !("undefined" == typeof isRtl || !isRtl),
        negateIfRTL: "undefined" != typeof isRtl && isRtl ? -1 : 1,
        init: function() {
            b.organizationList = a("#organization-to-edit"), b.targetList = b.organizationList, this.jQueryExtensions(), this.attachOrganizationEditListeners(), this.setupInputWithDefaultTitle(), this.attachQuickSearchListeners(), this.attachThemeLocationsListeners(), this.attachTabsPanelListeners(), this.attachUnsavedChangesListener(), b.organizationList.length && this.initSortables(), organizations.oneThemeLocationNoOrganizations && a("#posttype-page").addSelectedToOrganization(b.addOrganizationItemToBottom), this.initManageLocations(), this.initAccessibility(), this.initToggles(), this.initPreviewing()
        },
        jQueryExtensions: function() {
            a.fn.extend({
                organizationItemDepth: function() {
                ...
                updateDepthClass: function(b, c) {
                    return this.each(function() {
                        var d = a(this);
                        c = c || d.organizationItemDepth(), a(this).removeClass("organization-item-depth-" + c).addClass("organization-item-depth-" + b)
                    })
                },
                shiftDepthClass: function(b) {
                    return this.each(function() {
                        var c = a(this),
                            d = c.organizationItemDepth();
                        a(this).removeClass("organization-item-depth-" + d).addClass("organization-item-depth-" + (d + b))
                    })
                },
                childOrganizationItems: function() {
                    var b = a();
                    return this.each(function() {
                        for (var c = a(this), d = c.organizationItemDepth(), e = c.next(); e.length && e.organizationItemDepth() > d;) b = b.add(e), e = e.next()
                    }), b
                },
                ...
                moveHorizontally: function(b, c) {
                    ...
                    return this.each(function() {
                        var d = a(this),
                            e = d.childOrganizationItems(),
                            f = b - c,
                            g = d.find(".is-suborganization");
                        d.updateDepthClass(b, c).updateParentOrganizationItemDBId(), e && e.each(function() {
                            var b = a(this),
                                c = b.organizationItemDepth(),
                                d = c + f;
                            b.updateDepthClass(d, c).updateParentOrganizationItemDBId()
                        }), 0 === b ? g.hide() : g.show()

                    })
                },
                updateParentOrganizationItemDBId: function() {

                    return this.each(function() {
                        var b = a(this),
                            c = b.find(".organization-item-data-parent-id"),
                            d = parseInt(b.organizationItemDepth(), 10),
                            e = d - 1,
                            f = b.prevAll(".organization-item-depth-" + e).first();
                        c.val(0 === d ? 0 : f.find(".organization-item-data-db-id").val())
                    })
                },
                hideAdvancedOrganizationItemFields: function() {
                    return this.each(function() {
                        var b = a(this);
                ...
                addSelectedToOrganization: function(c) {
                    return 0 === a("#organization-to-edit").length ? !1 : this.each(function() {
                        var d = a(this),
                            e = {},
                            f = d.find(organizations.oneThemeLocationNoOrganizations && 0 === d.find(".tabs-panel-active .categorychecklist li input:checked").length ? '#page-all li input[type="checkbox"]' : ".tabs-panel-active .categorychecklist li input:checked"),
                            g = /organization-item\[([^\]]*)/;
                        return c = c || b.addOrganizationItemToBottom, f.length ? (d.find(".spinner").show(), a(f).each(function() {
                            var d = a(this),
                                f = g.exec(d.attr("name")),
                                h = "undefined" == typeof f[1] ? 0 : parseInt(f[1], 10);
                            this.className && -1 != this.className.indexOf("add-to-top") && (c = b.addOrganizationItemToTop), e[h] = d.closest("li").getItemData("add-organization-item", h)
                        }), void b.addItemToOrganization(e, c, function() {
                            f.removeAttr("checked"), d.find(".spinner").hide()
                        })) : !1
                    })
                },
                getItemData: function(a, b) {
                    a = a || "organization-item";
                    var c, d = {},
                        e = ["organization-item-db-id", "organization-item-object-id", "organization-item-object", "organization-item-parent-id", "organization-item-position", "organization-item-type", "organization-item-title", "organization-item-url", "organization-item-description", "organization-item-attr-title", "organization-item-target", "organization-item-classes", "organization-item-xfn"];
                    return b || "organization-item" != a || (b = this.find(".organization-item-data-db-id").val()), b ? (this.find("input").each(function() {
                        var f;
                        for (c = e.length; c--;) "organization-item" == a ? f = e[c] + "[" + b + "]" : "add-organization-item" == a && (f = "organization-item[" + b + "][" + e[c] + "]"), this.name && f == this.name && (d[e[c]] = this.value)
                    }), d) : d
                },
                setItemData: function(b, c, d) {
                    return c = c || "organization-item", d || "organization-item" != c || (d = a(".organization-item-data-db-id", this).val()), d ? (this.find("input").each(function() {
                        var e, f = a(this);
                        a.each(b, function(a, b) {
                            "organization-item" == c ? e = a + "[" + d + "]" : "add-organization-item" == c && (e = "organization-item[" + d + "][" + a + "]"), e == f.attr("name") && f.val(b)
                        })
                    }), this) : this
                }
            })
        },
        countOrganizationItems: function(b) {
            return a(".organization-item-depth-" + b).length
        },
        moveOrganizationItem: function(c, d) {
            var e, f, g, h = a("#organization-to-edit li"),
                i = h.length,
                j = c.parents("li.organization-item"),
                k = j.childOrganizationItems(),
                l = j.getItemData(),
                m = parseInt(j.organizationItemDepth(), 10),
                n = parseInt(j.index(), 10),
                o = j.next(),
                p = o.childOrganizationItems(),
                q = parseInt(o.organizationItemDepth(), 10) + 1,
                r = j.prev(),
                s = parseInt(r.organizationItemDepth(), 10),
                t = r.getItemData()["organization-item-db-id"];
            switch (d) {
                case "up":
                    if (f = n - 1, 0 === n) break;
                    0 === f && 0 !== m && j.moveHorizontally(0, m), 0 !== s && j.moveHorizontally(s, m), k ? (e = j.add(k), e.detach().insertBefore(h.eq(f)).updateParentOrganizationItemDBId()) : j.detach().insertBefore(h.eq(f)).updateParentOrganizationItemDBId();
                    break;
                case "down":
                    if (k) {
                        if (e = j.add(k), o = h.eq(e.length + n), p = 0 !== o.childOrganizationItems().length, p && (g = parseInt(o.organizationItemDepth(), 10) + 1, j.moveHorizontally(g, m)), i === n + e.length) break;
                        e.detach().insertAfter(h.eq(n + e.length)).updateParentOrganizationItemDBId()
                    } else {
                        if (0 !== p.length && j.moveHorizontally(q, m), i === n + 1) break;
                        j.detach().insertAfter(h.eq(n + 1)).updateParentOrganizationItemDBId()
                    }
                    break;
                case "top":
                    if (0 === n) break;
                    k ? (e = j.add(k), e.detach().insertBefore(h.eq(0)).updateParentOrganizationItemDBId()) : j.detach().insertBefore(h.eq(0)).updateParentOrganizationItemDBId();
                    break;
                case "left":
                    if (0 === m) break;
                ...
                case "right":
                    if (0 === n) break;
                    if (l["organization-item-parent-id"] === t) break;
                    j.shiftHorizontally(1)
            }
            c.focus(), b.registerChange(), b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility()
        },
        initAccessibility: function() {
            var c = a("#organization-to-edit");
            b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility(), c.on("click", ".organizations-move-up", function(c) {
                b.moveOrganizationItem(a(this).parents("li.organization-item").find("a.item-edit"), "up"), c.preventDefault()
            }), c.on("click", ".organizations-move-down", function(c) {
                b.moveOrganizationItem(a(this).parents("li.organization-item").find("a.item-edit"), "down"), c.preventDefault()
            }), c.on("click", ".organizations-move-top", function(c) {
                b.moveOrganizationItem(a(this).parents("li.organization-item").find("a.item-edit"), "top"), c.preventDefault()
            }), c.on("click", ".organizations-move-left", function(c) {
                b.moveOrganizationItem(a(this).parents("li.organization-item").find("a.item-edit"), "left"), c.preventDefault()
            }), c.on("click", ".organizations-move-right", function(c) {
                b.moveOrganizationItem(a(this).parents("li.organization-item").find("a.item-edit"), "right"), c.preventDefault()
            })
        },
        refreshAdvancedAccessibility: function() {
            a(".organization-item-settings .field-move a").css("display", "none"), a(".item-edit").each(function() {
                var b, c, d, e, f, g, h, i, j, k = a(this),
                    l = k.closest("li.organization-item").first(),
                    m = l.organizationItemDepth(),
                    n = 0 === m,
                    o = k.closest(".organization-item-handle").find(".organization-item-title").text(),
                    p = parseInt(l.index(), 10),
                    q = n ? m : parseInt(m - 1, 10),
                    r = l.prevAll(".organization-item-depth-" + q).first().find(".organization-item-title").text(),
                    s = l.prevAll(".organization-item-depth-" + m).first().find(".organization-item-title").text(),
                    t = a("#organization-to-edit li").length,
                    u = l.nextAll(".organization-item-depth-" + m).length;
                0 !== p && (b = l.find(".organizations-move-up"), b.prop("title", organizations.moveUp).css("display", "inline")), 0 !== p && n && (b = l.find(".organizations-move-top"), b.prop("title", organizations.moveToTop).css("display", "inline")), p + 1 !== t && 0 !== p && (b = l.find(".organizations-move-down"), b.prop("title", organizations.moveDown).css("display", "inline")), 0 === p && 0 !== u && (b = l.find(".organizations-move-down"), b.prop("title", organizations.moveDown).css("display", "inline")), n || (b = l.find(".organizations-move-left"), c = organizations.outFrom.replace("%s", r), b.prop("title", organizations.moveOutFrom.replace("%s", r)).html(c).css("display", "inline")), 0 !== p && l.find(".organization-item-data-parent-id").val() !== l.prev().find(".organization-item-data-db-id").val() && (b = l.find(".organizations-move-right"), c = organizations.under.replace("%s", s), b.prop("title", organizations.moveUnder.replace("%s", s)).html(c).css("display", "inline")), n ? (d = a(".organization-item-depth-0"), e = d.index(l) + 1, t = d.length, f = organizations.organizationFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$d", t)) : (g = l.prevAll(".organization-item-depth-" + parseInt(m - 1, 10)).first(), h = g.find(".organization-item-data-db-id").val(), i = g.find(".organization-item-title").text(), j = a('.organization-item .organization-item-data-parent-id[value="' + h + '"]'), e = a(j.parents(".organization-item").get().reverse()).index(l) + 1, f = organizations.subOrganizationFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$s", i)), k.prop("title", f).html(f)
            })
        },
        refreshKeyboardAccessibility: function() {
            a(".item-edit").off("focus").on("focus", function() {
                a(this).off("keydown").on("keydown", function(c) {
                    var d, e = a(this),
                        f = e.parents("li.organization-item"),
                        g = f.getItemData();
                    if ((37 == c.which || 38 == c.which || 39 == c.which || 40 == c.which) && (e.off("keydown"), 1 !== a("#organization-to-edit li").length)) {
                        switch (d = {
                            38: "up",
                            40: "down",
                            37: "left",
                            ...
                            case "up":
                                b.moveOrganizationItem(e, "up");
                                break;
                            case "down":
                                b.moveOrganizationItem(e, "down");
                                break;
                            case "left":
                                b.moveOrganizationItem(e, "left");
                                break;
                            case "right":
                                b.moveOrganizationItem(e, "right")
                        }
                        return a("#edit-" + g["organization-item-db-id"]).focus(), !1
                    }
                })
            })
        },
        initPreviewing: function() {
            a("#organization-to-edit").on("change input", ".edit-organization-item-title", function(b) {
                var c, d, e = a(b.currentTarget);
                c = e.val(), d = e.closest(".organization-item").find(".organization-item-title"), c ? d.text(c).removeClass("no-title") : d.text(navOrganizationL10n.untitled).addClass("no-title")
            })
        },
        initToggles: function() {
            postboxes.add_postbox_toggles("nav-organizations"), columns.useCheckboxesForHidden(), columns.checked = function(b) {
                a(".field-" + b).removeClass("hidden-field")
            }, columns.unchecked = function(b) {
                a(".field-" + b).addClass("hidden-field")
            }, b.organizationList.hideAdvancedOrganizationItemFields(), a(".hide-postbox-tog").click(function() {
        ...
        initSortables: function() {
            function c(a) {
                var c;
                j = a.placeholder.prev(), k = a.placeholder.next(), j[0] == a.item[0] && (j = j.prev()), k[0] == a.item[0] && (k = k.next()), l = j.length ? j.offset().top + j.height() : 0, m = k.length ? k.offset().top + k.height() / 3 : 0, h = k.length ? k.organizationItemDepth() : 0, i = j.length ? (c = j.organizationItemDepth() + 1) > b.options.globalMaxDepth ? b.options.globalMaxDepth : c : 0
            }
            ...
            function e() {
                ...
                var a = s[0].className.match(/organization-max-depth-(\d+)/);
            ...
            function f(c) {
                ...
                if (0 !== c) {
                    if (c > 0) d = p + c, d > t && (e = d);
                        ...
                        for (; !a(".organization-item-depth-" + e, b.organizationList).length && e > 0;) e--;
                    s.removeClass("organization-max-depth-" + t).addClass("organization-max-depth-" + e), t = e
                }
            }
            var g, h, i, j, k, l, m, n, o, p, q = 0,
                r = b.organizationList.offset().left,
                s = a("body"),
                t = e();
            0 !== a("#organization-to-edit li").length && a(".drag-instructions").show(), r += b.isRTL ? b.organizationList.width() : 0, b.organizationList.sortable({
                handle: ".organization-item-handle",
                placeholder: "sortable-placeholder",
                start: function(e, f) {
                    var h, i, j, k, l;
                    b.isRTL && (f.item[0].style.right = "auto"), o = f.item.children(".organization-item-transport"), g = f.item.organizationItemDepth(), d(f, g), j = f.item.next()[0] == f.placeholder[0] ? f.item.next() : f.item, k = j.childOrganizationItems(), o.append(k), h = o.outerHeight(), h += h > 0 ? 1 * f.placeholder.css("margin-top").slice(0, -2) : 0, h += f.helper.outerHeight(), n = h, h -= 2, f.placeholder.height(h), p = g, k.each(function() {
                        var b = a(this).organizationItemDepth();
                        p = b > p ? b : p
                    }), i = f.helper.find(".organization-item-handle").outerWidth(), i += b.depthToPx(p - g), i -= 2, f.placeholder.width(i), l = f.placeholder.next(), l.css("margin-top", n + "px"), f.placeholder.detach(), a(this).sortable("refresh"), f.item.after(f.placeholder), l.css("margin-top", 0), c(f)
                },
                stop: function(a, c) {
                    var d, e, h = q - g;
                    d = o.children().insertAfter(c.item), e = c.item.find(".item-title .is-suborganization"), q > 0 ? e.show() : e.hide(), 0 !== h && (c.item.updateDepthClass(q), d.shiftDepthClass(h), f(h)), b.registerChange(), c.item.updateParentOrganizationItemDBId(), c.item[0].style.top = 0, b.isRTL && (c.item[0].style.left = "auto", c.item[0].style.right = 0), b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility()
                },
                change: function(a, d) {
                    d.placeholder.parent().hasClass("organization") || (j.length ? j.after(d.placeholder) : b.organizationList.prepend(d.placeholder)), c(d)
                },
                sort: function(e, f) {
        ...
        initManageLocations: function() {
            a("#organization-locations-wrap form").submit(function() {
                window.onbeforeunload = null
            }), a(".organization-location-organizations select").on("change", function() {
                var b = a(this).closest("tr").find(".locations-edit-organization-link");
                a(this).find("option:selected").data("orig") ? b.show() : b.hide()
            })
        },
        attachOrganizationEditListeners: function() {
            var b = this;
            a("#update-nav-organization").bind("click", function(a) {
                if (a.target && a.target.className) {
                    if (-1 != a.target.className.indexOf("item-edit")) return b.eventOnClickEditLink(a.target);
                    if (-1 != a.target.className.indexOf("item-delete")) return b.eventOnClickOrganizationItemDelete(a.target);
        ...
        attachThemeLocationsListeners: function() {
            var b = a("#nav-organization-theme-locations"),
                c = {};
            c.action = "organization-locations-save", c["organization-settings-column-nonce"] = a("#organization-settings-column-nonce").val(), b.find('input[type="submit"]').click(function() {
        ...
        updateQuickSearchResults: function(c) {
            ...
            g.length < f || (d = c.parents(".tabs-panel"), e = {
                action: "organization-quick-search",
                "response-format": "markup",
                organization: a("#organization").val(),
                "organization-settings-column-nonce": a("#organization-settings-column-nonce").val(),
                q: g,
                type: c.attr("name")
        ...
        addOrganizationItemToBottom: function(c) {
            a(c).hideAdvancedOrganizationItemFields().appendTo(b.targetList), b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility()
        },
        addOrganizationItemToTop: function(c) {
            a(c).hideAdvancedOrganizationItemFields().prependTo(b.targetList), b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility()
        },
        attachUnsavedChangesListener: function() {
            a("#organization-management input, #organization-management select, #organization-management, #organization-management textarea, .organization-location-organizations select").change(function() {
                b.registerChange()
            }), 0 !== a("#organization-to-edit").length || 0 !== a(".organization-location-organizations select").length ? window.onbeforeunload = function() {
             
            } : a("#organization-settings-column").find("input,select").end().find("a").attr("href", "#").unbind("click")
        },
        registerChange: function() {
            b.organizationsChanged = !0
        },
        attachTabsPanelListeners: function() {
            a("#organization-settings-column").bind("click", function(c) {
                ...
                if (h.hasClass("nav-tab-link")) e = h.data("type"), f = h.parents(".accordion-section-content").first(), a("input", f).removeAttr("checked"), a(".tabs-panel-active", f).removeClass("tabs-panel-active").addClass("tabs-panel-inactive"), a("#" + e, f).removeClass("tabs-panel-inactive").addClass("tabs-panel-active"), a(".tabs", f).removeClass("tabs"), h.parent().addClass("tabs"), a(".quick-search", f).focus(), c.preventDefault();
                    ...
                    if (d = /#(.*)$/.exec(c.target.href), d && d[1]) return g = a("#" + d[1] + " .tabs-panel-active .organization-item-title input"), g.length === g.filter(":checked").length ? g.removeAttr("checked") : g.prop("checked", !0), !1
                } else {
                    if (h.hasClass("submit-add-to-organization")) return b.registerChange(), c.target.id && "submit-customlinkdiv" == c.target.id ? b.addCustomLink(b.addOrganizationItemToBottom) : c.target.id && -1 != c.target.id.indexOf("submit-") && a("#" + c.target.id.replace(/submit-/, "")).addSelectedToOrganization(b.addOrganizationItemToBottom), !1;
                    if (h.hasClass("page-numbers")) return a.post(ajaxurl, c.target.href.replace(/.*\?/, "").replace(/action=([^&]*)/, "") + "&action=organization-get-metabox", function(b) {
        ...
        eventOnClickEditLink: function(b) {
            ...
            return e && e[1] && (c = a("#" + e[1]), d = c.parent(), 0 !== d.length) ? (d.hasClass("organization-item-edit-inactive") ? (c.data("organization-item-data") || c.data("organization-item-data", c.getItemData()), c.slideDown("fast"), d.removeClass("organization-item-edit-inactive").addClass("organization-item-edit-active")) : (c.slideUp("fast"), d.removeClass("organization-item-edit-active").addClass("organization-item-edit-inactive")), !1) : void 0
        },
        eventOnClickCancelLink: function(b) {
            var c = a(b).closest(".organization-item-settings"),
                d = a(b).closest(".organization-item");
            return d.removeClass("organization-item-edit-active").addClass("organization-item-edit-inactive"), c.setItemData(c.data("organization-item-data")).hide(), !1
        },
       
        eventOnClickOrganizationItemDelete: function(c) {
...
if (r == true) {
   var d = parseInt(c.id.replace("delete-", ""), 10);
            ...
            return b.removeOrganizationItem(a("#organization-item-" + d)), b.registerChange(), !1
	...
	return false;
        ...
        processQuickSearchQueryResponse: function(b, c, d) {
            var e, f, g, h = {},
                i = document.getElementById("nav-organization-meta"),
                j = /organization-item[(\[^]\]*/,
                k = a("<div>").html(b).find("li");
            return k.length ? (k.each(function() {
                if (g = a(this), e = j.exec(g.html()), e && e[1]) {
                    for (f = e[1]; i.elements["organization-item[" + f + "][organization-item-type]"] || h[f];) f--;
                    h[f] = !0, f != e[1] && g.html(g.html().replace(new RegExp("organization-item\\[" + e[1] + "\\]", "g"), "organization-item[" + f + "]"))
                }
            }), a(".categorychecklist", d).html(k), void a(".spinner", d).hide()) : (a(".categorychecklist", d).html("<li><p>" + navOrganizationL10n.noResultsFound + "</p></li>"), void a(".spinner", d).hide())
        },
        removeOrganizationItem: function(b) {
            var c = b.childOrganizationItems();
            b.addClass("deleting").animate({
                opacity: 0,
                height: 0
            }, 350, function() {
                var d = a("#organization-instructions");
                b.remove(), c.shiftDepthClass(-1).updateParentOrganizationItemDBId(), 0 === a("#organization-to-edit li").length && (a(".drag-instructions").hide(), d.removeClass("organization-instructions-inactive"))
            })
        },
        depthToPx: function(a) {
            return a * b.options.organizationItemDepthPerLevel
        },
        pxToDepth: function(a) {
            return Math.floor(a / b.options.organizationItemDepthPerLevel)
        }
    }, a(document).ready(function() {
        wpNavOrganization.init()
    })
}(jQuery);
